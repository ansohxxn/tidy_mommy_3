...
public class BoardInput : MonoBehaviour, IPointerClickHandler, IPointerDownHandler, IPointerUpHandler
{
    ...
    public void OnPointerClick(PointerEventData eventData)
    {
        ...
        {
            Transform pos = Get_Selected_Frame_Pos();
            if (pos != null) 
                Managers.Game.selectedFrame.Setting(board.GetLastRowBlock((int)colID), pos);
        }
    ...
    private Transform Get_Selected_Frame_Pos()
    {
        int col = (int)colID;
